...
ContactPop = {
    ...
    replaceHref : 'Contact/contact-pop.php', // can be array or string of hrefs or nothing if you want to use jQuery selectors (below)
    
    formPhpLocation : '/Contact/contact-pop.php', // relative path to the backend contact form
